...
const theServer = new Server(async (req, res) => {
	...
	const requestedFilePath = (pathToMainFolder + req.url).replace(/\%\2\0/g, " ");
	...
	if("GET" == req.method) {
	   	...
	   	if(await fileExistsAndIsNotDirectory) {
    		...
    		if(path.extname(requestedFilePath).match(/.?html?/)) {
    		    ...
    		    contents += '<script src="' + pathToMainFolderStartingFromHTMLFileToBeServed + '/' + pathToErudaStartingFromMainFolder + '"></script>\n<script>eruda.init();</script>';
